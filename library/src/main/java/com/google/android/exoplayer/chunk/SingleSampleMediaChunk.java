...
public final class SingleSampleMediaChunk extends BaseMediaChunk {
  ...
  private final MediaFormat_vadio sampleFormat;
  ...
  public SingleSampleMediaChunk(DataSource dataSource, DataSpec dataSpec, int trigger,
      Format format, long startTimeUs, long endTimeUs, int chunkIndex, MediaFormat_vadio sampleFormat,
  ...
  @Override
  public MediaFormat_vadio getMediaFormat() {
    return sampleFormat;
  }
