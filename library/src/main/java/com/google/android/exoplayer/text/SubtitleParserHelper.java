...
/* package */ final class SubtitleParserHelper implements Handler.Callback {
   ...
   */
  public void setFormat(MediaFormat_vadio format) {
  ...
  public boolean handleMessage(Message msg) {
    switch (msg.what) {
      case MSG_FORMAT:
        handleFormat((MediaFormat_vadio) msg.obj);
        break;
      case MSG_SAMPLE:
  ...
  private void handleFormat(MediaFormat_vadio format) {
    subtitlesAreRelative = format.subsampleOffsetUs == MediaFormat_vadio.OFFSET_SAMPLE_RELATIVE;
